...
/**
 * Performance test for the Camera entity.
 */
class CameraGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Camera entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created camera")
                .get("${new_camera_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created camera")
            .delete("${new_camera_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
