...
describe('Service Tests', () => {
    ...
    describe('PerimeterProtectRegion Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PerimeterProtectRegionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/perimeter-protect-regions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PerimeterProtectRegion', () => {

                let entity: PerimeterProtectRegion;
                service.find(123).subscribe((_entity: PerimeterProtectRegion) => {
                    entity = _entity;
                });
